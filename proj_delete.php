	...
	<body>
		...
		<div class="w3-content w3-padding" style="max-width:1564px">
			...
			<div class="w3-container w3-padding-32" id="blog">
				<h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Delete Entry</h3>
			</div>
			
		

        	<form method="POST" action="proj_del.php">
				<p><label>Date of the entry which you wish to be deleted: </label>
